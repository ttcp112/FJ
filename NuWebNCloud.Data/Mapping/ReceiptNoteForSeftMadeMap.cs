...
{
    public class ReceiptNoteForSeftMadeMap : EntityTypeConfiguration<I_ReceiptNoteForSeftMade>
    {
        public ReceiptNoteForSeftMadeMap()
        {
            this.HasKey(aa => aa.Id);
            this.Property(aa => aa.Id).HasMaxLength(50);
            this.ToTable("I_ReceiptNoteForSeftMade");
