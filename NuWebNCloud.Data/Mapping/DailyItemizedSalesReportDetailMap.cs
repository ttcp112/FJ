...
{
    public class DailyItemizedSalesReportDetailMap : EntityTypeConfiguration<R_DailyItemizedSalesReportDetail>
    {
        public DailyItemizedSalesReportDetailMap()
        {
            this.ToTable("R_DailyItemizedSalesReportDetail");
            ...
            this.Property(aa => aa.ItemId).IsRequired().HasMaxLength(250);
            this.Property(aa => aa.ItemCode).IsOptional().HasMaxLength(100);
