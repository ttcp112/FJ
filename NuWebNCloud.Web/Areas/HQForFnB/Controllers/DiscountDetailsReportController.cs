...
{
    [NuAuth]
    public class DiscountDetailsReportController : BaseController
    {
        private static Logger _logger = LogManager.GetCurrentClassLogger();
        // GET: DiscountDetailsReport
        ...
        public ActionResult Report(BaseReportModel model)
        {
            try
            {
                ...
                ////    //lstStore = new List<StoreModels>() { new StoreModels() { Id = "cf92d3fc-72d6-4b9c-a7b3-b62cff916832", Name = "keke" } };
                ...
                //XLWorkbook wb = factory.Report_NewDB(model, lstStore);
                #endregion Report with New DB
                ViewBag.wb = wb;
                string sheetName = string.Format("Report_Discount_Details_{0}", DateTime.Now.ToString("MMddyyyy")).Replace(" ", "_");
                Response.Clear();
            ...
            {
                _logger.Error("Discount Details Report Error: " + ex);
